...
class StudentForm extends Component {
  ...
  componentDidMount = async()=>{
    ...
    try {
      ...
      this.setState({firstName:data[0].Name,studentNumber: data[0].StudentID,
      studentYear: data[0].StudentYear,
      studentCourse: data[0].StudentCourse,
      presentStreetAddress: data[0].Address,
      presentState: data[0].State});
    } catch (error) {
